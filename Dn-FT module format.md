...
| ***Version***        | ***Module Version*** | ***PARAMS*** | ***INFO*** | ***TUNING*** | ***HEADER*** | ***INSTRUMENTS*** | ***SEQUENCES*** | ***FRAMES*** | ***PATTERNS*** | ***TRACK*** | ***DPCM SAMPLES*** | ***COMMENTS*** | ***SEQUENCES_VRC6*** | ***SEQUENCES_N163*** | ***SEQUENCES_S5B*** |
| -------------------- | -------------------- | ------------ | ---------- | ------------ | ------------ | ----------------- | --------------- | ------------ | -------------- | ----------- | ------------------ | -------------- | -------------------- | -------------------- | ------------------- |
...
| **0.5.0 beta 3**     | 4.50 (0x0450)        | 9            | 1          | -            | 4            | 8                 | 6               | 3            | 6              | -           | 1                  | 1              | 6                    | 1                    | 1                   |
...
| ***Version***         | ***Module Version*** | ***PARAMS*** | ***INFO*** | ***TUNING*** | ***HEADER*** | ***INSTRUMENTS*** | ***SEQUENCES*** | ***FRAMES*** | ***PATTERNS*** | ***TRACK*** | ***DPCM SAMPLES*** | ***COMMENTS*** | ***SEQUENCES_VRC6*** | ***SEQUENCES_N163*** | ***SEQUENCES_S5B*** | ***PARAMS_EXTRA*** | ***DETUNETABLES*** | ***GROOVES*** | ***BOOKMARKS*** |
| --------------------- | -------------------- | ------------ | ---------- | ------------ | ------------ | ----------------- | --------------- | ------------ | -------------- | ----------- | ------------------ | -------------- | -------------------- | -------------------- | ------------------- | ------------------ | ------------------ | ------------- | --------------- |
...
| **0.3.3**             | 4.40 (0x0440)        | 6            | 1          | -            | 3            | 6                 | 6               | 3            | 5              | -           | 1                  | 1              | 6                    | 1                    | 1\*                 | -                  | 1                  | -             | -               |
