...
| _Data type_  | _Unit size (bytes)_                    | _Repeat_ | _Object/relevant variable in code_ | _Description_           | _Valid range_             | _Notes_                 | _Present in block version_ |
| ------------ | -------------------------------------- | -------- | ---------------------------------- | ----------------------- | ------------------------- | ----------------------- | -------------------------- |
| unsigned int | 4                                      | Per song | `m_iFrameCount`                    | Track frame count       | 1 to `MAX_FRAMES`         |                         | 1-3                        |
| unsigned int | 4                                      | ^        | `m_iChannelsAvailable`             | Channel count           | 0 to `MAX_CHANNELS`       | Moved to `PARAMS` block | 1                          |
| unsigned int | 4                                      | ^        | `m_iSongSpeed`                     | Track default speed     | 0 to `MAX_TEMPO`          |                         | 3                          |
| unsigned int | 4                                      | ^        | `m_iSongTempo`                     | Track default tempo     | 0 to `MAX_TEMPO`          |                         | 2-3                        |
| unsigned int | 4                                      | ^        | `m_iPatternLength`                 | Track default row count | 1 to `MAX_PATTERN_LENGTH` | Pattern length          | 2-3                        |
| char[]       | `m_iChannelsAvailable * m_iFrameCount` | ^        | `Pattern`                          | Pattern indices         | 0 to `MAX_PATTERN - 1`    | Pattern data            | 1-3                        |
#### Notes
